...
// Interface cannot have constructor, can have public constants(cannot be overriden)
// All methods in interface must be public
// We can extends multiple interface in a interface: DebtCollector extends Interface1, Interface2
