...
// ToasterPro inherits all public and protected properties and methods
...
class ToasterPro extends Toaster{
    ...
    public function addSlice(string $slice): void{
        parent::addSlice(); // We copied same functionality just to show use of parent
    }
    ...
    // When You are inhereting, you are inheretin all the props and methods of parent class, doesn't matter it needs or doesn't need in Child Class
